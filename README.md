# wizard.jsx/tidalSOSclub & Google's Style Guide for simple proxy for local development
...
```
cd
git clone https://github.com/user/microdev style-config
```
...
```
~/style-config/microdev-config.sh
```
